...
<head>
  ...
  <!-- bootstrap.min css -->
  <link rel="stylesheet" href="{{ asset('home/assets/vendors/bootstrap/bootstrap.css') }}">
  <!-- Iconfont Css -->
  <link rel="stylesheet" href="{{ asset('home/assets/vendors/awesome/css/fontawesome-all.min.css') }}">
  <link rel="stylesheet" href="{{ asset('home/aassets/vendors/flaticon/flaticon.css') }}">
  <link rel="stylesheet" href="{{ asset('home/assets/fonts/gilroy/font-gilroy.css') }}">
  <link rel="stylesheet" href="{{ asset('home/assets/vendors/magnific-popup/magnific-popup.css') }}">
  <!-- animate.css -->
  <link rel="stylesheet" href="{{ asset('home/assets/vendors/animate-css/animate.css') }}">
  <link rel="stylesheet" href="{{ asset('home/assets/vendors/animated-headline/animated-headline.css') }}">
  <link rel="stylesheet" href="{{ asset('home/assets/vendors/owl/assets/owl.carousel.min.css') }}">
  <link rel="stylesheet" href="{{ asset('home/assets/vendors/owl/assets/owl.theme.default.min.css') }}">

  <!-- Main Stylesheet -->
  <link rel="stylesheet" href="{{ asset('home/assets/css/woocomerce.css') }}">
